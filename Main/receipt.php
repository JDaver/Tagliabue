...
<html>
    ...
    <div class="titleReceipt">
        <?php echo"<h1>Scontrino Numero: ". $_SESSION['name']."</h1>";?>
    </div>
    <div class="formContainer">
                <form action="receipt.php" method="post" class="search-container">
                    <label for="">Scannerizza l'articolo </label>
                    <input type="text" name="eanItem">  <br>
                    <label for="numero">Inserisci la quantita</label>
                    <input type="number" id="numero" name="numero" min="1" max="100" value="1">
                    
                    <button type="submit" name="insItem">Inserisci l'aricolo nel carrello</button>   <br><br>
                    <button type="submit" name="conclusion">Concludi l'ordine</button>
                    <button type="submit" name="delete">Elimina scontrino</button>
                </form>
